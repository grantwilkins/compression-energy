...
int main(int argc, char *argv[])
{
  ...
  double bounds[] = {1e-6, 5e-6, 1e-5, 5e-5, 1e-4, 5e-4, 1e-3, 5e-3, 1e-2, 5e-2, 1e-1};
  ...
  for (size_t c = 0; c < n_compressors; ++c) {
    ...
    if (comp == NULL) continue;  // Skip if compressor wasn't initialized
