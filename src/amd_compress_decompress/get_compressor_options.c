...
int main(int argc, char *argv[]) {
  ...
  struct pressio_options *configuration =
      pressio_compressor_get_configuration(comp);
  ...
  struct pressio_options *documentation =
      pressio_compressor_get_documentation(comp);
